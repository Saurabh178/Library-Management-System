...
<!--Maths section-->
    ...
    <form method="post" id="mathsCheckInOut">
      <div class="modal fade" id="maths" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            if($result){
                                ...
                                while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                                    ...
                                    echo "
                                        ...
                                        <td>
                                        <div>
                                        <label for='mathscheck'>
                                        <input type='radio' name='mathscheck$divId' value='Issue'>
                                        Issue</label>
                                        </div>
                                        <div>
                                        <label for='mathscheck'>
                                        <input type='radio' name='mathscheck$divId' value='Return' >
                                        Return</label>
                                        </div>
                                        </td>
                                        </tr>";
