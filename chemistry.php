...
<!--Chemistry section-->
    ...
    <form method="post" id="chemCheckInOut">
      <div class="modal fade" id="chem" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            if($result){
                                ...
                                while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                                    ...
                                    echo "
                                        ...
                                        <div>
                                        <label for='chemcheck'>
                                        <input type='radio' name='chemcheck$divId' value='Issue'>
                                        Issue</label>
                                        </div>
                                        <div>
                                        <label for='chemcheck'>
                                        <input type='radio' name='chemcheck$divId' value='Return' >
                                        Return</label>
                                        </div>
                                        </td>
                                        </tr>";
