...
<!--Physics section-->
    ...
    <form method="post" id="phyCheckInOut">
      <div class="modal fade" id="phy" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            if($result){
                                ...
                                while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                                    ...
                                    echo "
                                        ...
                                        <div>
                                        <label for='phycheck'>
                                        <input type='radio' name='phycheck$divId' value='Issue'>
                                        Issue</label>
                                        </div>
                                        <div>
                                        <label for='phycheck'>
                                        <input type='radio' name='phycheck$divId' value='Return' >
                                        Return</label>
                                        </div>
                                        </td>
                                        </tr>";
